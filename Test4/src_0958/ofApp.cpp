...
//	kinect.drawDepth(ofGetWindowWidth()/2, 0);
	...
	vector<Kv2Skeleton> mySkeletons = kinect.getSkeletons();
	{
		...
		for (int i = 0; i < mySkeletons.size(); i++)
		{
			if (mySkeletons[i].tracked) {
				...
				verdana30.drawString("Left hand pos.X    " + ofToString(left_hand_pos.x), 1600, 100 + 90 * i);
				verdana30.drawString("Left hand Pos.Y    " + ofToString(left_hand_pos.y), 1600, 125 + 90 * i);
				verdana30.drawString("Left hand Pos.Z    " + ofToString(left_hand_pos.z), 1600, 150 + 90 * i);
			//	verdana30.drawString("Left knee Pos.Z    " + ofToString(left_knee_pos.z), 1600, 175 + 90 * i);

				verdana30.drawString("Right hand pos.X    " + ofToString(right_hand_pos.x), 1600, 10 + 90 * i);
				verdana30.drawString("Right hand Pos.Y    " + ofToString(right_hand_pos.y), 1600, 35 + 90 * i);
				verdana30.drawString("Right hand Pos.Z    " + ofToString(right_hand_pos.z), 1600, 60 + 90 * i);
		//		verdana30.drawString("Right knee Pos.Z    " + ofToString(right_knee_pos.z), 1600, 85 + 90 * i);
				...
				if (left_hand_pos.y>spinebase_pos.y && left_hand_pos.y<spinemid_pos.y && left_shoulder_right_shoulder_hand_elbow_with_right_hand_pos<60 && left_shoulder_right_shoulder_hand_elbow_with_right_hand_pos>30 &&
					...
					mCenter.draw(500, (wave *  ofGetHeight()*.5));
				...
				verdana30.drawString("head Pos.Y    " + ofToString(head_pos.y), 800, 130 + 90 * i);
				verdana30.drawString("head Pos.Z    " + ofToString(head_pos.z), 800, 160 + 90 * i);
				}

				/*
				verdana30.drawString("lHand_shoulder.X    " + ofToString(left_hand_shoulder.x), 800, 200 + 90 * i);
				verdana30.drawString("lHand_shoulder.Y    " + ofToString(left_hand_shoulder.y), 800, 230 + 90 * i);
				verdana30.drawString("lHand_shoulder.Z    " + ofToString(left_hand_shoulder.z), 800, 260 + 90 * i);

				verdana30.drawString("Angle of lShoulder-Elbow-Hand    " + ofToString(left_shoulder_hand_elbow_with_left_hand_pos), 800, 300 + 90 * i);
				verdana30.drawString("Angle of rShoulder-Elbow-Hand    " + ofToString(right_shoulder_hand_elbow_with_right_hand_pos), 800, 330 + 90 * i);

				ofSetColor(255, 0, 0);
				verdana30.drawString("Balance: neck-hip pos.X    " + ofToString(neck_hip.x), 800, 400 + 90 * i);
				verdana30.drawString("lAngle btw arm & spine    " + ofToString(left_angle_elbow_shoulder_with_neck_hip), 800, 430 + 90 * i);
				//verdana30.drawString("neck_hip Pos.Z    " + ofToString(neck_hip.z), 800, 460 + 90 * i);
